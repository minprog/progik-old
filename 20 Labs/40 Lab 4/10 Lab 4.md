...
**Canopy users you should disable Canopy's PyLab setting.** Here is how:
...
**Last resort!** If your Python does not support turtle graphics, use this online turtle version!

[turtle within skulpt's in-browser Python](http://www.skulpt.org/#)
...
[http://docs.python.org/library/turtle.html](http://docs.python.org/library/turtle.html)
...
# Starting `hw2pr1.py`: the _poly_ function...

Start a new Python source code file named `hw2pr1.py`. Feel free to paste this starter code, including a header comment (with your name), along with the import statement:
...
* load this file with `python -i hw2pr1.py` at the command-line 
...
Create your own recursive (and/or non-recursive) art! The extra-credit problem (hw2pr4.zip) invites you to try this...
...
## Submitting hw2pr1.py

For the lab, you'll submit only the source code, `hw2pr1.py`
